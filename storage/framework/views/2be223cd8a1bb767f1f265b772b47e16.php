...
<head>
    ...
    <title>Register - ElektraFit</title>
    ...
    <div class="register-container">
        ...
        <form method="POST" action="<?php echo e(route('register.submit')); ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" placeholder="Enter your full name" value="<?php echo e(old('name')); ?>" required>
...
<?php /**PATH C:\Apache24\htdocs\Elektra\resources\views/auth/register.blade.php ENDPATH**/ ?>