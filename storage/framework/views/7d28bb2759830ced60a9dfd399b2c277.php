...
<head>
  ...
  <?php echo app('Illuminate\Foundation\Vite')(['resources/css/hero.css']); ?>
</head>
<body>
  <header class="hero">
    ...
    <nav class="site-nav">
      <div class="brand">
        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="ElektraFit Logo" class="brand-logo" style="filter: brightness(0) saturate(100%) invert(64%) sepia(100%) saturate(1000%) hue-rotate(170deg);" />
      ...
      <a class="btn-join" href="<?php echo e(route('login')); ?>">Join Now</a>
    </nav>
