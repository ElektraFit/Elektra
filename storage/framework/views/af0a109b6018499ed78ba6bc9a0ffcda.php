...
<body>
    ...
    <div class="otp-container">
        ...
        <?php if(session('status')): ?>
            <div class="status-message status-success"><?php echo e(session('status')); ?></div>
        <?php endif; ?>
        
        <?php if(session('error')): ?>
            <div class="status-message status-error"><?php echo e(session('error')); ?></div>
        <?php endif; ?>
        
        <form action="<?php echo e(route('otp.submit')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            
            <div class="form-group">
                <label for="email">Email</label>
                <input type="email" id="email" name="email" placeholder="Enter your email" value="<?php echo e(old('email', session('otp_email'))); ?>" required readonly>
            </div>
            ...
            <div class="form-group">
                ...
                <?php if($errors->has('otp')): ?>
                    <div class="error"><?php echo e($errors->first('otp')); ?></div>
                <?php endif; ?>
            </div>
...
<?php /**PATH C:\Apache24\htdocs\Elektra\resources\views/auth/otp.blade.php ENDPATH**/ ?>