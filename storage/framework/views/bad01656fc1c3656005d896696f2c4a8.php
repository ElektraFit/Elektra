...
<head>
    ...
    <title><?php echo e(config('app.name')); ?> - ElektraFit|Homepage</title>
...
<body class="bg-background text-foreground">
    ...
    <header class="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-md border-b border-border">
        <div class="container mx-auto px-4 py-4 flex items-center justify-between">
            <div class="flex items-center gap-2">
                ...
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="ElektraFit Logo" class="h-8 w-8" style="filter: brightness(0) saturate(100%) invert(64%) sepia(100%) saturate(1000%) hue-rotate(170deg);" />
                <span class="font-orbitron text-2xl font-black text-gradient tracking-wider">ElektraFit</span>
            </div>
            
            <nav class="hidden md:flex items-center gap-8">
                <a href="<?php echo e(url('/#home')); ?>" class="text-foreground hover:text-primary transition-colors">Home</a>
                <a href="<?php echo e(url('/#services')); ?>" class="text-foreground hover:text-primary transition-colors">Services</a>
                <a href="<?php echo e(url('/#membership')); ?>" class="text-foreground hover:text-primary transition-colors">Membership</a>
                <a href="<?php echo e(url('/#about')); ?>" class="text-foreground hover:text-primary transition-colors">About</a>
                <a href="<?php echo e(url('/#contact')); ?>" class="text-foreground hover:text-primary transition-colors">Contact</a>
            </nav>
    ...
    <div class="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
        ...
        <div 
            ...
            style="background-image: url('<?php echo e(asset('images/gym-equipment.png')); ?>')"
        ></div>
...
</html><?php /**PATH C:\Apache24\htdocs\Elektra\resources\views/homepagesuccess.blade.php ENDPATH**/ ?>